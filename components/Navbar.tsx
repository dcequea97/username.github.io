      ...
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <button 
            ...
            className="flex items-center gap-2 border border-emerald-400 text-emerald-400 px-4 py-2 rounded text-sm hover:bg-emerald-400/10 transition-colors font-mono min-w-[4rem] justify-center"
        ...
        <div className="md:hidden flex items-center space-x-4">
          <button 
            onClick={toggleLanguage}
            className="flex items-center gap-2 border border-emerald-400 text-emerald-400 px-3 py-1 rounded text-xs hover:bg-emerald-400/10 transition-colors font-mono"
          >
             <i className="fa-solid fa-globe"></i>
             <span>{language === 'en' ? 'ES' : 'EN'}</span>
          </button>
